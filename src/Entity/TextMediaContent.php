...
use App\Repository\TextMediaContentRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TextMediaContentRepository::class)]
class TextMediaContent
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToOne(inversedBy: 'textMediaContent', cascade: ['persist', 'remove'])]
